...
graph TD
    ...
    style A fill:#143a2b,stroke:#16a34a,stroke-width:2px,color:#f8fafc
    style B fill:#2d333b,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style C fill:#323942,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style D fill:#4a3500,stroke:#a16207,stroke-width:2px,color:#f8fafc
    style E fill:#103460,stroke:#2563eb,stroke-width:2px,color:#f8fafc
    style F fill:#2d333b,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
```

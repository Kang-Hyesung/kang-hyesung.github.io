...
graph TD
    ...
    %% 스타일 정의
    style Method_Area fill:#075985,stroke:#38bdf8,stroke-width:2px,color:#f8fafc
    style Heap_Area fill:#14532d,stroke:#15803d,stroke-width:2px,color:#f8fafc
    style Stack_Area fill:#7c2d12,stroke:#fb923c,stroke-width:2px,color:#f8fafc
    style StaticVar fill:#1f2937,stroke:#38bdf8,color:#f8fafc
    style StaticMethod fill:#1f2937,stroke:#38bdf8,color:#f8fafc

...
graph LR
    ...
    %% 스타일 정의
    style Object_Instance fill:#374151,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    ...
    style C fill:#075985,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style A1 fill:#1f2937,stroke:#4b5563,stroke-dasharray: 5 5,color:#f8fafc
    style A2 fill:#1f2937,stroke:#4b5563,stroke-dasharray: 5 5,color:#f8fafc
...
graph TD
    ...
    %% 스타일 정의 (파스텔 톤)
    style MarkWord fill:#374151,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style A fill:#075985,stroke:#94a3b8,color:#f8fafc
    style B fill:#854d0e,stroke:#94a3b8,color:#f8fafc
    style C fill:#9f1239,stroke:#94a3b8,color:#f8fafc
    style D fill:#166534,stroke:#94a3b8,color:#f8fafc
    style E fill:#0f766e,stroke:#94a3b8,color:#f8fafc

...
graph TD
    ...
    style C fill:#7f1d1d,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style D fill:#075985,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style F fill:#14532d,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
...
graph LR
    ...
    %% 스타일 정의
    style E fill:#1e3a8a,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style S0 fill:#713f12,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style S1 fill:#713f12,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style O fill:#14532d,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style M fill:#6b21a8,stroke:#94a3b8,stroke-width:2px,color:#f8fafc

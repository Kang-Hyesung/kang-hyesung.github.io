...
graph TD
    ...
    %% 스타일 정의 (클래스 정의 방식 사용)
    classDef stackFill fill:#374151,stroke:#94a3b8,stroke-width:2px,color:#f8fafc;
    classDef heapFill fill:#166534,stroke:#94a3b8,stroke-width:2px,color:#f8fafc;
    classDef poolFill fill:#854d0e,stroke:#a16207,stroke-width:2px,stroke-dasharray: 5 5,color:#f8fafc;

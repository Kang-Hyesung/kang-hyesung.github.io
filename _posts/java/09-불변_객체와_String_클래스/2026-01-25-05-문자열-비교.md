...
graph LR
    ...
    %% 스타일 정의
    style Hello fill:#166534,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style WorldPool fill:#166534,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style WorldHeap fill:#854d0e,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style JavaHeap fill:#854d0e,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style s1 fill:#075985,stroke:#94a3b8,color:#f8fafc
    style s3 fill:#991b1b,stroke:#94a3b8,color:#f8fafc
    style s4 fill:#991b1b,stroke:#94a3b8,color:#f8fafc

...
graph TD
    ...
    %% 스타일 정의
    style Heap fill:#374151,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style Internal fill:#075985,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style S1 fill:#854d0e,stroke:#94a3b8,color:#f8fafc
    style S2 fill:#854d0e,stroke:#94a3b8,color:#f8fafc
...
graph LR
    ...
    %% 스타일 정의
    style Stack fill:#374151,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style Heap fill:#1e3a8a,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style Pool fill:#713f12,stroke:#facc15,stroke-width:2px,stroke-dasharray: 5 5,color:#f8fafc
    style L1 fill:#a16207,stroke:#facc15,color:#f8fafc
    style O1 fill:#991b1b,stroke:#dc2626,color:#f8fafc
```

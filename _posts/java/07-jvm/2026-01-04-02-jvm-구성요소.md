...
graph TB
    ...
    %% 스타일 정의
    style Heap fill:#7f1d1d,stroke:#94a3b8,color:#f8fafc
    style Method fill:#7f1d1d,stroke:#94a3b8,color:#f8fafc
    style T1 fill:#1e3a8a,stroke:#94a3b8,color:#f8fafc
    style T2 fill:#1e3a8a,stroke:#94a3b8,color:#f8fafc

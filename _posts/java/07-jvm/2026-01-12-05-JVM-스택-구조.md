...
graph TD
    ...
    %% 스타일 정의
    style JVM_Runtime_Data_Area fill:#374151,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style Heap fill:#854d0e,stroke:#a16207,stroke-width:2px,color:#f8fafc
    style Stack1 fill:#166534,stroke:#166534,stroke-width:2px,color:#f8fafc
    style Stack2 fill:#166534,stroke:#166534,stroke-width:2px,color:#f8fafc
    style Frame1 fill:#1f2937,stroke:#94a3b8,color:#f8fafc
    style Frame2 fill:#1f2937,stroke:#94a3b8,color:#f8fafc
    style Frame3 fill:#1f2937,stroke:#94a3b8,color:#f8fafc

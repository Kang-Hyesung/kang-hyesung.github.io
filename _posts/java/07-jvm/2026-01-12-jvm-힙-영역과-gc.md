...
graph TD
    ...
    %% 스타일 정의
    style JVM_Memory fill:#374151,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style Young_Gen fill:#075985,stroke:#38bdf8,stroke-width:2px,color:#f8fafc
    style Old_Gen fill:#854d0e,stroke:#a16207,stroke-width:2px,color:#f8fafc
    style Meta_Space fill:#14532d,stroke:#15803d,stroke-width:2px,color:#f8fafc
    style Eden fill:#1f2937,stroke:#94a3b8,color:#f8fafc
    style S0 fill:#1f2937,stroke:#94a3b8,color:#f8fafc
    style S1 fill:#1f2937,stroke:#94a3b8,color:#f8fafc
    style Old fill:#1f2937,stroke:#94a3b8,color:#f8fafc
    style Meta fill:#1f2937,stroke:#94a3b8,color:#f8fafc
...
graph LR
    ...
    style B fill:#075985,stroke:#94a3b8,color:#f8fafc
    style G fill:#854d0e,stroke:#94a3b8,color:#f8fafc

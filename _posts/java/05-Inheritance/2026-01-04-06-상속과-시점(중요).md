...
graph TD
    ...
    %% 스타일 정의
    style Flow fill:#075985,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style Check fill:#854d0e,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style Implementation fill:#166534,stroke:#94a3b8,stroke-width:2px,stroke-dasharray: 5, 5,color:#f8fafc
```

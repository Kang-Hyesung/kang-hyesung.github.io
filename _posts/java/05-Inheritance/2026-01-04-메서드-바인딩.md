...
graph TD
    ...
    %% 스타일 정의
    style P1 fill:#374151,stroke:#94a3b8,color:#f8fafc
    style P2 fill:#374151,stroke:#94a3b8,color:#f8fafc
    style P3 fill:#374151,stroke:#94a3b8,color:#f8fafc
    style C2 fill:#991b1b,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style C3 fill:#166534,stroke:#94a3b8,color:#f8fafc

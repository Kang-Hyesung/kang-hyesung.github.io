...
classDiagram
    ...
    %% 스타일 정의
    style Mammal fill:#075985,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style Lion fill:#854d0e,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style Human fill:#166534,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
...
graph TD
    ...
    style HeapMemory fill:#374151,stroke:#94a3b8,color:#f8fafc
    style ChildInstance fill:#9a3412,stroke:#c2410c,stroke-width:2px,color:#f8fafc
    style ParentPart fill:#854d0e,stroke:#94a3b8,color:#f8fafc
    style ChildPart fill:#166534,stroke:#94a3b8,color:#f8fafc

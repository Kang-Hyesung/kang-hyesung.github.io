...
graph LR
    ...
    %% 스타일 정의
    style Ref fill:#075985,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style Heap fill:#7f1d1d,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style VTable fill:#854d0e,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style C_Method fill:#166534,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style P_Method fill:#374151,stroke:#4b5563,stroke-dasharray: 5 5,color:#f8fafc

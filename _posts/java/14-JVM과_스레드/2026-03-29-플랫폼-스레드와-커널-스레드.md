...
```mermaid
graph TD
    subgraph jvm_area [JVM Runtime Data Area]
        subgraph t1_area [Thread 1 Isolated]
            A["Stack"]
            B["PC Register"]
            C["Native Method Stack"]
        end
        
        subgraph t2_area [Thread 2 Isolated]
            D["Stack"]
            E["PC Register"]
...
    %% 스타일 정의
    style A fill:#3f6212,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style B fill:#3f6212,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style C fill:#3f6212,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style D fill:#3f6212,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style E fill:#3f6212,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style F fill:#3f6212,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style G fill:#9a3412,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
```
...
public class ThreadMemoryModel {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        */
        ...
        // Thread(Runnable target, String name) 생성자 사용
        // 첫 번째 인자 model::performTask는 스레드가 실행할 작업이고,
        // 두 번째 인자 "Thread-1", "Thread-2"는 각 Thread 객체에 붙이는 이름이다.
        // 이 이름은 performTask()의 멤버나 지역 변수가 아니라 Thread 객체 자체의 속성이며,
        // Thread.currentThread().getName()을 통해 현재 실행 중인 스레드의 이름으로 조회된다.
        Thread t1 = new Thread(model::performTask, "Thread-1");

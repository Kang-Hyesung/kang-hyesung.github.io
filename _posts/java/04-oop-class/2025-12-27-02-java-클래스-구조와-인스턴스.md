...
graph LR
    ...
    style StackArea fill:#1e3a8a,stroke:#2563eb,stroke-width:2px,rx:15,ry:15,color:#f8fafc
    ...
    style HeapArea fill:#7c2d12,stroke:#fb923c,stroke-width:2px,rx:15,ry:15,color:#f8fafc

    %% 노드 스타일링 (깔끔한 흰색 배경으로 통일)
    style ref fill:#1f2937,stroke:#2563eb,color:#f8fafc
    style local fill:#1f2937,stroke:#2563eb,color:#f8fafc
    style obj fill:#1f2937,stroke:#fb923c,color:#f8fafc
    style field fill:#1f2937,stroke:#fb923c,stroke-dasharray: 5 5,color:#f8fafc

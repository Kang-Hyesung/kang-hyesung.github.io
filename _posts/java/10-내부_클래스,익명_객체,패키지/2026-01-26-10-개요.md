...
graph TD
    ...
    style F fill:#991b1b,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
...
graph LR
    ...
    style User fill:#374151,stroke:#94a3b8,color:#f8fafc
    style Loop fill:#581c87,stroke:#94a3b8,color:#f8fafc
    style Handler fill:#854d0e,stroke:#94a3b8,color:#f8fafc

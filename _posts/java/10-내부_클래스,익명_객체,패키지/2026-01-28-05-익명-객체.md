...
graph LR
    ...
    %% 스타일 정의
    style CompileTime fill:#374151,stroke:#94a3b8,stroke-dasharray: 5 5,color:#f8fafc
    style Runtime fill:#4d7c0f,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    
    style Code fill:#1f2937,stroke:#94a3b8,color:#f8fafc
    style Compiler fill:#581c87,stroke:#94a3b8,color:#f8fafc
    style ClassFile fill:#1e3a8a,stroke:#2563eb,color:#f8fafc
    style AnonClassFile fill:#1e3a8a,stroke:#2563eb,color:#f8fafc
    
    style StackMemory fill:#9a3412,stroke:#a16207,color:#f8fafc
    style HeapMemory fill:#166534,stroke:#15803d,color:#f8fafc
    style AnonInstance fill:#1f2937,stroke:#15803d,stroke-width:2px,color:#f8fafc
```

...
flowchart LR
    ...
    style Client fill:#374151,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style Outer fill:#166534,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
    style Inner fill:#854d0e,stroke:#94a3b8,stroke-width:2px,color:#f8fafc
```

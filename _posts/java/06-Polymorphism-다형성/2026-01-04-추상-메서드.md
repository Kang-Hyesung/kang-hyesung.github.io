...
graph TD
    ...
    %% 스타일 정의
    classDef abstract fill:#854d0e,stroke:#a16207,stroke-width:2px;color:#f8fafc;
    classDef concrete fill:#166534,stroke:#166534,stroke-width:2px;color:#f8fafc;
    classDef logic fill:#374151,stroke:#4b5563,stroke-dasharray: 5 5;color:#f8fafc;

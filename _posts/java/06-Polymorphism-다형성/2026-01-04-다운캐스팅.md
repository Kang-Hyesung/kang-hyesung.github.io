...
graph TD
    ...
    %% 스타일 정의
    style A fill:#991b1b,stroke:#b71c1c,stroke-width:2px,color:#f8fafc
    style B fill:#9a3412,stroke:#c2410c,stroke-width:2px,color:#f8fafc
    style C fill:#713f12,stroke:#facc15,stroke-width:2px,color:#f8fafc
